...
export const ROM_DATA = {
  ...
  subtalar_inversion: {
    ...
    normalMax: 20,
    unit: 'degrees',
    referenceRangeText: '0° – 20° (AAOS: 20°–22° isolated hindfoot tilt)',
    functionalRange: '15° (Walking across sloping ground, trail running)',
    hypermobilityThreshold: 28,
    impingementRiskThreshold: 35,
    sliderMin: 0,
    sliderMax: 30,
    ...
    arthrokinematics: {
      ...
      description: 'Isolated subtalar motion: Calcaneus tilts into inversion (medially) relative to the talus in the frontal plane (~20°). Midfoot joints remain in baseline alignment.',
  ...
  subtalar_eversion: {
    ...
    normalMax: 10,
    unit: 'degrees',
    referenceRangeText: '0° – 10° (AAOS: 10°–12° isolated hindfoot tilt)',
    functionalRange: '8° – 10° (Adapting to uneven surfaces)',
    ...
    arthrokinematics: {
      ...
      description: 'Isolated subtalar motion: Calcaneus tilts into eversion (laterally) relative to the talus in the frontal plane (~10°). Midfoot remains in baseline alignment.',
      closePacked: 'Full inversion',
      loosePacked: 'Neutral'
    },
    muscles: {
  ...
  subtalar_pronation: {
    ...
    normalMax: 20,
    unit: 'degrees',
    referenceRangeText: '0° – 20° (Subtalar ~10° + Midfoot TNCC ~10°)',
    functionalRange: '12° – 15° (Loading response in gait, shock absorption, ground contouring)',
    hypermobilityThreshold: 28,
    impingementRiskThreshold: 35,
    sliderMin: 0,
    sliderMax: 30,
    ...
    arthrokinematics: {
      ...
      description: 'TNCC Parallel Alignment (Neumann Ch. 14, pp. 614–616, Fig 14.24): In pronation, the Talonavicular (TN) and Calcaneocuboid (CC) joint axes align PARALLEL to one another, unlocking the transverse tarsal joint into a flexible shock absorber. Combined motion roughly doubles isolated subtalar range! In closed kinetic chain, drives ~6°–10° of coupled Tibial Internal Rotation.',
  ...
  subtalar_supination: {
    ...
    normalMax: 35,
    unit: 'degrees',
    referenceRangeText: '0° – 35° (Subtalar ~20° + Midfoot TNCC ~15°)',
    functionalRange: '25° – 30° (Terminal stance push-off, rigid propulsion lever)',
    hypermobilityThreshold: 45,
